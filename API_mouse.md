...
| RX78::Device::ToAbs<small>RX78设备.到绝对坐标         | 通过**到绝对坐标**实现                             | 硬件实现                                          | 硬件实现                                             |
| RX78::Device::MoveRel<small>RX78设备.相对移动</small> | 通过**到绝对坐标**实现                             | 通过到绝对坐标实现                                | 通过**到绝对坐标**实现                               |
| RX78::Device::MoveAbs<small>RX78设备.绝对移动</small> | 通过**到绝对坐标**实现                             | 通过到绝对坐标实现                                | 通过**到绝对坐标动**实现                             |
